...
class EuropeanClosing:
    ...
    def move_eurex_time_of_sale(self):
        ...
        shutil.copy("C:\\Program Files (x86)\\Ralota\\PPro8 Jawa\\TOS_2.log", "C:\\logs\\"+currentdate.year.__str__() +
    ...
    @staticmethod
    def main():
        startEuroClose = EuropeanClosing("C:\\logs\\Milan.csv")
        // WAIT UNTIL 11:00 AM AND START TIME OF SALE (TOS2) FOR EUROPEAN CLOSE
        startEuroClose.register_eure_time_of_sale()
        // WAIT UNTIL 11:41 AM AND MOVE TIME OF SALE (TOS2) FOR EUROPEAN CLOSE to LOGFILE LOCATED \logs\YYYY-MM-DD\Europe.csv
        startEuroClose.move_eurex_time_of_sale()
        currentdate = datetime.now()
        startEuroClose.get_EUREX(currentdate)
